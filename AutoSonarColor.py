    ...
    while True:
	    ...
	    GPIO.output(LED_B, GPIO.LOW)
            ...
            if Distance_test() > 50:
                ...
                spin_right()
                time.sleep(0.2)
                pwm_ServoSonar.ChangeDutyCycle(6)
                time.sleep(0.2)
                pwm_ServoSonar.ChangeDutyCycle(0)
                print("resetting Servo")
                
                GPIO.output(LED_R, GPIO.LOW)#green on
                GPIO.output(LED_G, GPIO.HIGH)
                GPIO.output(LED_B, GPIO.LOW)
                GPIO.output(LED_R, GPIO.LOW)#green off
                GPIO.output(LED_G, GPIO.LOW)
                GPIO.output(LED_B, GPIO.LOW)
